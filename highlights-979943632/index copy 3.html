...
<html>
	<head>
		...
		<link rel="stylesheet" href="assets/css/main copy 3.css" />
	...
	<body>
		...
		<!-- One -->
			<section id="one" class="main special">
				<div class="container">
					<span class="image fit primary"><img src="images/mofo.jpg" alt="" /></span>
					<div class="content">
						<header class="major">
							<h2>Youtube Coverage</h2>
						</header>
						<p> I run a dedicated channel on Youtube, covering top plays and kills from all channels across the community. Click <a href="https://www.youtube.com/channel/UCvyAsQ2ps4hy9Xv7k-XGeYw?view_as=subscriber" target="_blank">here</a> to check them out! </p>
					</div>
		...
		<!-- Three -->
			<section id="three" class="main special">
				<div class="container">
					<span class="image fit primary"><img src="images/youtube.jpg" alt="" /></span>
					<div class="content">
						<header class="major">
