...
<html>
	<head>
		...
		<link rel="stylesheet" href="assets/css/main copy 8.css" />
			...
			<section id="one" class="main special">
				<div class="container">
					...
					<div class="content">
						...
						<p> I am a part of an active community that works with developers to assist them in community test environments to try out content still in development. This is a platform that has paved the way for newcomers to become full time streamers and Youtubers that are now the unofficial representatives of players across the world.</p>
					</div>
			...
			<section id="three" class="main special">
				<div class="container">
					...
					<div class="content">
                        ...
                        <p> If you like what you see and wish to be a part of this active community, head down below and hit us up! We'll get in touch with you shortly!</p>
					</div>
