...
<html>
	<head>
		...
		<link rel="stylesheet" href="assets/css/main copy 2.css" />
	...
	<body>
		...
		<!-- One -->
			<section id="one" class="main special">
				<div class="container">
					<span class="image fit primary"><img src="images/merch.jpg" alt="" /></span>
					<div class="content">
						<header class="major">
							<h2>Battlefield 1 Merchandise</h2>
						</header>
						<p>If you a diehard fan of the entire Battlefield franchise and don’t want to miss anything, the Deluxe Collector’s Edition for Battlefield 1 is for you! This premium box includes the base game (PS4 or Xbox One), 14″ collector’s statue, exclusive steel book, deck of playing cards, cloth poster, messenger pigeon tube with code for exclusive DLC content and a patch. It does not include a Season pass. </p>
					</div>
