...
<html>
	<head>
		...
		<link rel="stylesheet" href="assets/css/main copy 4.css" />
	...
	<body>
		...
		<!-- Header -->
			<section id="header">
				<header class="major">
					<h1>Check out all the latest developments from E3, PAX and others!</h1>
				</header>
				<div class="container">
					<ul class="actions">
		...
		<!-- One -->
			<section id="one" class="main special">
				<div class="container">
					<span class="image fit primary"><img src="images/e3.jpg" alt="" /></span>
					<div class="content">
						<header class="major">
							<h2>Electronic Entertainment Expo and others</h2>
						</header>
                        <p>The Electronic Entertainment Expo, commonly referred to as E3, is a premier trade event for the video game industry.Presented by the Entertainment Software Association (ESA), it is used by many developers, publishers and hardware and accessory manufacturers to introduce and advertise upcoming games and game-related merchandise to retailers and members of the press.
