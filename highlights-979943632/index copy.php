	...
	<body>
		...
		<!-- One -->
			<section id="one" class="main special">
				<div class="container">
					<span class="image fit primary"><img src="images/achievement.jpg" alt="" /></span>
					<div class="content">
						<header class="major">
							<h2>Battlefield 1 Acheivements</h2>
						</header>
						<p>For hardcore completionists, collecting in-game trophies has always been its own reward. However, now that PlayStation has announced that its Rewards program in the US will take trophies into account, earning you PSN store credit for devoted play, the average player has a nice incentive to begin trophy hunting.
                        
                        Silver trophies count for one point, gold trophies for <b> 10 </b> and platinum for <b> 100 </b> each. As you'd expect, the bronze trophies won't get you anything. Once you’ve collected <b> 1000 points </b> (10 Platinum trophies), you’ll be able to exchange them for <b> $10 </b> of PSN credit. </p>
					</div>
