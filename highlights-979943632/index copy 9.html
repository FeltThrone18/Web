...
<html>
	<head>
		...
		<link rel="stylesheet" href="assets/css/main copy 9.css" />
	...
	<body>
		...
		<!-- One -->
			<section id="one" class="main special">
				<div class="container">
					<span class="image fit primary"><img src="images/cte.jpg" alt="" /></span>
					<div class="content">
						<header class="major">
							<h2>Community Test Environment (CTE)</h2>
						</header>
                        <p>
			...
			<section id="three" class="main special">
				<div class="container">
					...
					<div class="content">
                        ...
                        <p>More details on the CTE and the registration process can be found
                        <a href="https://www.reddit.com/r/battlefield_live/wiki/cte/registercompanionpc" target="_blank">here</a>
                        </p>
					</div>
