...
<html>
	<head>
		...
		<link rel="stylesheet" href="assets/css/main copy 7.css" />
	...
	<body>
		...
		<!-- One -->
			<section id="one" class="main special">
				<div class="container">
					<span class="image fit primary"><img src="images/sponsor.jpg" alt="" /></span>
					<div class="content">
						<header class="major">
							<h2>Sponsorhsips!</h2>
						</header>
                        <p>Are You A Gaming Influencer?
                        Any of these gamer types can start making money today. </p>
					</div>
