...
<html>
	<head>
		...
		<link rel="stylesheet" href="assets/css/main copy 10.css" />
	...
	<body>
		...
		<!-- One -->
			<section id="one" class="main special">
				<div class="container">
					<span class="image fit primary"><img src="images/BF1-4.jpg" alt="" /></span>
					<div class="content">
						<header class="major">
							<h2>Online is where we are!</h2>
						</header>
						<p>Please head over to the official Battlefield 1's <a href= "https://twitter.com/battlefield?lang=en" target="_blank">official twitter page</a> to stay updated on all activities Battlefield! </p>
					</div>
		...
		<!-- Three -->
			<section id="three" class="main special">
				<div class="container">
					<span class="image fit primary"><img src="images/BF1-4.jpeg" alt="" /></span>
					<div class="content">
						<header class="major">
